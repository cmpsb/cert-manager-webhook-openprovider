...
func (o *LoginOK) Error() string {
	return fmt.Sprintf("[POST /v1beta/auth/login][%d] loginOK  %+v", 200, o.Payload)
}
...
func (o *LoginOK) GetPayload() *models.AuthLoginResponse {
	return o.Payload
}
...
func (o *LoginDefault) Error() string {
	return fmt.Sprintf("[POST /v1beta/auth/login][%d] Login default  %+v", o._statusCode, o.Payload)
}
...
func (o *LoginDefault) GetPayload() *models.ErrorError {
	return o.Payload
}

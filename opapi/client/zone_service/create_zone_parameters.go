...
type CreateZoneParams struct {
	...
	// Body.
	Body *models.ZoneCreateZoneRequest
...
func (o *CreateZoneParams) WithBody(body *models.ZoneCreateZoneRequest) *CreateZoneParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create zone params
func (o *CreateZoneParams) SetBody(body *models.ZoneCreateZoneRequest) {
	o.Body = body
}
